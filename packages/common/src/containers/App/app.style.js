...
const GlobalStyle = createGlobalStyle`
  ...
  section{
    ...
    button.modalCloseBtn {
      ...
      &.alt {
        background-color: ${themeGet('colors.primary', '#6c5c7a')} !important;
        border-radius: 50% !important;
        z-index: 999999 !important;
        padding: 0 !important;
        box-shadow: 0 8px 38px rgba(250, 94, 127, 0.5) !important;
...
const AppWrapper = styled.div`
    ...
    .reusecore__button {
      .btn-icon {
        ...
        @media only screen and (max-width: 1100px) {
          color: ${themeGet('colors.primary', '#6c5c7a')};
        }
    ...
    .hamburgMenu__bar {
      ...
      > span {
        ...
        @media only screen and (max-width: 990px) {
          background-color: ${themeGet('colors.primary', '#6c5c7a')};
        }
      }
    }
  }
  ...
  .reusecore__button {
    ...
    .btn-icon {
      ...
      display: -ms-flexbox;
      display: flex;
      color: rgb(250, 94, 127);
      width: 35px;
    }
    &:hover {
      box-shadow: 0px 9px 20px -5px rgba(250, 94, 127, 0.57);
      background-color: rgb(250, 94, 127);
      cursor: pointer;
    }
    &.withoutBg {
      @media (max-width: 460px) {
